"""
Strategy: Strap
Buys two ATM calls and one ATM put at the same strike for the next weekly expiry.
Profits from a big move in either direction, but earns twice as much on an upward move.
A bullish-leaning volatility strategy.
"""
