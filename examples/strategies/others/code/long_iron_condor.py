...
Buys an OTM call (ATM+1) and an OTM put (ATM-1), and sells a further OTM
call (ATM+2) and put (ATM-2) as wings for the next weekly expiry.
Profits when Nifty moves beyond either of the inner bought strikes.
Opposite of the short iron condor.
"""
...
try:
    ...
    print(f"Short call (ATM+2) - Trading symbol : {short_call['trading_symbol']}")
    ...
    print(f"Short put  (ATM-2) - Trading symbol : {short_put['trading_symbol']}")

    # Step 2: Buy the OTM call (ATM+1)
    ...
    # Step 3: Sell the further OTM call wing (ATM+2)
    ...
    print(f"Long put order placed successfully. Order ID: {response3}")

    # Step 5: Sell the further OTM put wing (ATM-2)
    ...
    print(f"Short put order placed successfully. Order ID: {response4}")
