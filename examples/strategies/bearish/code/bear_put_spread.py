...
Buys an ATM Nifty 50 put option and sells an OTM put option (ATM-1 strike)
...
try:
    ...
    # Step 1: Find the ATM put option (long leg)
    ...
    # Step 2: Find the OTM put option one strike below ATM (short leg)
