...
Sells an ATM Nifty 50 call option and buys an OTM call option (ATM+1 strike)
...
try:
    ...
    # Step 1: Find the ATM call option (short leg)
    ...
    # Step 2: Find the OTM call option one strike above ATM (long leg)
