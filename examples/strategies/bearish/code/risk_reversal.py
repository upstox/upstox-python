...
Sells an OTM call (ATM+1) and buys an OTM put (ATM-1) for the next weekly expiry.
The premium collected from the sold call partially or fully finances the bought put.
Profits as Nifty falls; loses as Nifty rises.
"""
...
try:
    ...
    # Step 1: Find the OTM call (short leg)
    ...
    print(f"Short call (ATM+1) - Instrument key : {short_call['instrument_key']}")

    # Step 2: Find the OTM put (long leg)
