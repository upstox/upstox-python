...
Buys an ATM call, sells two ATM+1 calls, and buys an ATM+2 call
...
try:
    ...
    print(f"Upper long  (ATM+2) - Trading symbol : {upper_long['trading_symbol']}")
    ...
    # Step 3: Sell two middle calls (ATM+1)
    ...
    print(f"Middle short call order placed successfully. Order ID: {response2}")
    ...
    print(f"Upper long call order placed successfully. Order ID: {response3}")
