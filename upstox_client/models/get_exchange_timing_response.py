...
class GetExchangeTimingResponse(object):
    ...
    def __init__(self, status=None, data=None):  # noqa: E501
        """GetExchangeTimingResponse - a model defined in Swagger"""  # noqa: E501
        self._status = None
        self._data = None
    ...
    @property
    def status(self):
        """Gets the status of this GetExchangeTimingResponse.  # noqa: E501
    ...
    def status(self, status):
        """Sets the status of this GetExchangeTimingResponse.
    ...
    @property
    def data(self):
        """Gets the data of this GetExchangeTimingResponse.  # noqa: E501
    ...
    @data.setter
    def data(self, data):
        """Sets the data of this GetExchangeTimingResponse.
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(GetExchangeTimingResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GetExchangeTimingResponse):
            return False
